...
@implementation CLCollectionProvider
- (instancetype)init {
    self = [super init];
    if ( self ) {
...
//                LWZCollectionLayoutContentOrthogonalScrollingBehaviorPaging,
                ...
                for ( NSInteger i = 0 ; i < 9 ; ++ i ) {
                    CLCollectionItem *item = CLCollectionItem.alloc.init;
                    LWZCollectionBackgroundDecoration *decoration = [LWZCollectionBackgroundDecoration itemBackgroundDecorationWithBackgroundColor:UIColor.greenColor];

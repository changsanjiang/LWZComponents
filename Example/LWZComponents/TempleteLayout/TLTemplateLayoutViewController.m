//
//  TLTemplateLayoutViewController.m
...
@interface TLTemplateLayoutViewController ()<UICollectionViewDataSource, UICollectionViewDelegate, LWZCollectionViewTemplateLayoutDelegate>
@property (nonatomic, strong) LWZCollectionViewLayout *templateLayout;
@property (nonatomic, strong) UICollectionView *collectionView;
@property (nonatomic) CGFloat testMargin;
@end

@implementation TLTemplateLayoutViewController

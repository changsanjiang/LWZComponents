...
@interface WLPostVideoLayoutCollectionItem : WLPostCollectionItem
@end


@interface WLPostImageLayoutCollectionItem : WLPostCollectionItem
@end

@interface WLPostCollectionItem ()
...
@implementation WLPostCollectionItem {
    NSInteger _likingCount;
}
+ (instancetype)itemWithModel:(WLPostModel *)post {
    return post.video != nil ? [WLPostVideoLayoutCollectionItem.alloc initWithModel:post] : [WLPostImageLayoutCollectionItem.alloc initWithModel:post];
}
...
@interface WLPostVideoLayoutCollectionItem ()<WLPostVideoLayoutCollectionViewCellDataSource, WLPostVideoLayoutCollectionViewCellDelegate>
@property (nonatomic, strong, nullable) UIImage *cover;
@end

@implementation WLPostVideoLayoutCollectionItem {
    WLPostVideoLayoutCollectionViewCell *_cell;
}
...
- (Class)cellClass {
    return WLPostVideoLayoutCollectionViewCell.class;
}
...
- (void)bindCell:(WLPostVideoLayoutCollectionViewCell *)cell atIndexPath:(NSIndexPath *)indexPath {
    _cell = cell;
...
#pragma mark - WLPostVideoLayoutCollectionViewCellDelegate
...
@interface WLPostImageLayoutCollectionItem ()<WLPostImageLayoutCollectionViewCellDataSource, WLPostImageLayoutCollectionViewCellDelegate>
@property (nonatomic, strong, nullable) NSMutableArray<id<WLPostCoverItem>> *covers;
@end

@implementation WLPostImageLayoutCollectionItem {
    WLPostImageLayoutCollectionViewCell *_cell;
}
...
- (Class)cellClass {
    return WLPostImageLayoutCollectionViewCell.class;
}
...
- (void)bindCell:(WLPostImageLayoutCollectionViewCell *)cell atIndexPath:(NSIndexPath *)indexPath {
    _cell = cell;
    cell.dataSource = self;
    cell.delegate = self;
    if ( self.needsLayout ) [cell reloadDataSource];
...
#pragma mark - WLPostImageLayoutCollectionViewCellDelegate

...
@interface WLCollectionUserItem ()<WLCollectionUserCellDataSource>
@property (nonatomic, strong, nullable) UIImage *avatar;
@property (nonatomic, strong, nullable) NSString *name;
@end

@implementation WLCollectionUserItem
...
// 将要绑定的 cell 类
- (Class)cellClass {
    return WLCollectionUserCell.class;
}
...
// 绑定到 cell
// 一般在此处将数据配置到 cell 上
- (void)bindCell:(WLCollectionUserCell *)cell atIndexPath:(NSIndexPath *)indexPath {

//
//  WLCollectionPostVideoLayoutCell.m
...
@interface WLCollectionPostVideoLayoutCell ()
...
@implementation WLCollectionPostVideoLayoutCell
...
- (void)setDataSource:(nullable id<WLCollectionPostVideoLayoutCellDataSource>)dataSource {
